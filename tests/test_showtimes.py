...
def test_get_showtimes_parses_and_sorts():
    ...
    client.get_json.return_value = [
        ...
        {"scnsrtTm": "0900", "scnsNm": "4관[SCREENX]", "frSeatCnt": "28"},
    ]

    rows = get_showtimes(client, "0056", "30001192", "20260819")

    assert rows == [
        {"start": "0900", "screen": "4관[SCREENX]", "free_seats": "28"},
...
def test_get_showtimes_empty_when_no_data():
    from cgvwatch.cgv.showtimes import get_showtimes
    client = MagicMock()
    client.get_json.return_value = None
    assert get_showtimes(client, "0056", "30001192", "20260819") == []
